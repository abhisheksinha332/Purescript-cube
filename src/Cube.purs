...
renderView state = let
    ...
    in
        ...
        , renderButton "reverse X" (Reverse X)
        , renderButton "reverse Y" (Reverse Y)
        , renderButton "reverse Z" (Reverse Z)
        , renderButton "increase X" (Increase X)
        , renderButton "increase Y" (Increase Y)
        , renderButton "increase Z" (Increase Z)
        
        , renderButton "decrease X" (Decrease X)
        , renderButton "decrease Y" (Decrease Y)
        , renderButton "decrease Z" (Decrease Z)
